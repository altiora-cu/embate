...
--
-- Contiene: 0001_init.sql, 0002_rls.sql, 0003_match_flow.sql, 0004_storage.sql, 0005_open_limits_and_public.sql, 0006_plan_limits.sql, 0007_platform_admin.sql, 0008_community_chat.sql, 0009_league_legs_autofinish.sql
-- =============================================================================
...
-- ▼▼▼ 0009_league_legs_autofinish.sql ▼▼▼
